...
/*
|--------------------------------------------------------------------------
| API token Protected Route Filter
|--------------------------------------------------------------------------
|
| The Auth.Token filter is responsible for protecting application routes
| that require an api token from being accessed. It requires a header
| that sends the API token.
|
*/
